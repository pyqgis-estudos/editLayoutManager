...
from .layout_edit_dialog import editLayoutsDialog
import os.path
...
class editLayouts:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Layouts Editer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('editLayouts', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/layout_edit/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Edit Layouts'),
            callback=self.run,
